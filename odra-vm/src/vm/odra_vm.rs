...
#[derive(Default)]
pub struct OdraVm {
    state: RefCell<OdraVmState>,
    contract_register: RefCell<ContractRegister>
}
...
impl OdraVm {
    ...
    pub fn new_contract(
        ...
        // Register the contract under the address.
        {
            ...
            self.contract_register.borrow_mut().add(address, contract);
    ...
    pub fn call_contract(&self, address: Address, call_def: CallDef) -> Bytes {
        ...
        println!("call_contract {}", contract_name);
        ...
        println!("call_contract result {:?}", result);
        match result {
