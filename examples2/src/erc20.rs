...
mod __erc20_test_parts2 {
    ...
    impl Erc20Deployer {
        pub fn init(env: &odra2::HostEnv, total_supply: Option<U256>) -> Erc20HostRef {
            let epc = odra2::EntryPointsCaller::new(env.clone(), |contract_env, call_def| {
                ...
                match call_def.method() {
                    "init" => {
                        ...
                        odra2::types::Bytes::from(result.to_bytes().unwrap())
                    }
                    "total_supply" => {
